...
/**
 * Agency Agent Skill: Engineering Data Engineer
 * revenue: true
 */
...
class engineering-data-engineerSkill {
  constructor() {
    this.name = 'engineering-data-engineer';
    this.agentPath = '/root/.openclaw/workspace/agency-agents/engineering/engineering-data-engineer.md';
  }

  async execute(task, context = {}) {
    try {
      console.log('🤖 Executing Engineering Data Engineer agent...');
      ...
      console.log('✅ Engineering Data Engineer completed');
      return result;
    } catch (error) {
      console.error('❌ engineering-data-engineer error:', error.message);
      throw error;
    }
  }
...
module.exports = { engineering-data-engineerSkill };