...
/**
 * Agency Agent Skill: Engineering Security Engineer
 * revenue: true
 */
...
class engineering-security-engineerSkill {
  constructor() {
    this.name = 'engineering-security-engineer';
    this.agentPath = '/root/.openclaw/workspace/agency-agents/engineering/engineering-security-engineer.md';
  }

  async execute(task, context = {}) {
    try {
      console.log('🤖 Executing Engineering Security Engineer agent...');
      ...
      console.log('✅ Engineering Security Engineer completed');
      return result;
    } catch (error) {
      console.error('❌ engineering-security-engineer error:', error.message);
      throw error;
    }
  }
...
module.exports = { engineering-security-engineerSkill };