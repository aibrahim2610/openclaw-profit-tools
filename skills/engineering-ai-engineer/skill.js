...
/**
 * Agency Agent Skill: Engineering Ai Engineer
 * revenue: true
 */
...
class engineering-ai-engineerSkill {
  constructor() {
    this.name = 'engineering-ai-engineer';
    this.agentPath = '/root/.openclaw/workspace/agency-agents/engineering/engineering-ai-engineer.md';
  }

  async execute(task, context = {}) {
    try {
      console.log('🤖 Executing Engineering Ai Engineer agent...');
      ...
      console.log('✅ Engineering Ai Engineer completed');
      return result;
    } catch (error) {
      console.error('❌ engineering-ai-engineer error:', error.message);
      throw error;
    }
  }
...
module.exports = { engineering-ai-engineerSkill };