...
/**
 * Agency Agent Skill: Engineering Threat Detection Engineer
 * revenue: true
 */
...
class engineering-threat-detection-engineerSkill {
  constructor() {
    this.name = 'engineering-threat-detection-engineer';
    this.agentPath = '/root/.openclaw/workspace/agency-agents/engineering/engineering-threat-detection-engineer.md';
  }

  async execute(task, context = {}) {
    try {
      console.log('🤖 Executing Engineering Threat Detection Engineer agent...');
      ...
      console.log('✅ Engineering Threat Detection Engineer completed');
      return result;
    } catch (error) {
      console.error('❌ engineering-threat-detection-engineer error:', error.message);
      throw error;
    }
  }
...
module.exports = { engineering-threat-detection-engineerSkill };