...
/**
 * Agency Agent Skill: Design Ux Architect
 * revenue: true
 */
...
class design-ux-architectSkill {
  constructor() {
    this.name = 'design-ux-architect';
    this.agentPath = '/root/.openclaw/workspace/agency-agents/design/design-ux-architect.md';
  }

  async execute(task, context = {}) {
    try {
      console.log('🤖 Executing Design Ux Architect agent...');
      ...
      console.log('✅ Design Ux Architect completed');
      return result;
    } catch (error) {
      console.error('❌ design-ux-architect error:', error.message);
      throw error;
    }
  }
...
module.exports = { design-ux-architectSkill };