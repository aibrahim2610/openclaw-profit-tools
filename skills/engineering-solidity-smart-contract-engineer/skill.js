...
/**
 * Agency Agent Skill: Engineering Solidity Smart Contract Engineer
 * revenue: true
 */
...
class engineering-solidity-smart-contract-engineerSkill {
  constructor() {
    this.name = 'engineering-solidity-smart-contract-engineer';
    this.agentPath = '/root/.openclaw/workspace/agency-agents/engineering/engineering-solidity-smart-contract-engineer.md';
  }

  async execute(task, context = {}) {
    try {
      console.log('🤖 Executing Engineering Solidity Smart Contract Engineer agent...');
      ...
      console.log('✅ Engineering Solidity Smart Contract Engineer completed');
      return result;
    } catch (error) {
      console.error('❌ engineering-solidity-smart-contract-engineer error:', error.message);
      throw error;
    }
  }
...
module.exports = { engineering-solidity-smart-contract-engineerSkill };