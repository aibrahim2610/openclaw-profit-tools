...
/**
 * Agency Agent Skill: Engineering Frontend Developer
 * revenue: true
 */
...
class engineering-frontend-developerSkill {
  constructor() {
    this.name = 'engineering-frontend-developer';
    this.agentPath = '/root/.openclaw/workspace/agency-agents/engineering/engineering-frontend-developer.md';
  }

  async execute(task, context = {}) {
    try {
      console.log('🤖 Executing Engineering Frontend Developer agent...');
      ...
      console.log('✅ Engineering Frontend Developer completed');
      return result;
    } catch (error) {
      console.error('❌ engineering-frontend-developer error:', error.message);
      throw error;
    }
  }
...
module.exports = { engineering-frontend-developerSkill };