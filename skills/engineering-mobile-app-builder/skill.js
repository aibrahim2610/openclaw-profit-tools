...
/**
 * Agency Agent Skill: Engineering Mobile App Builder
 * revenue: true
 */
...
class engineering-mobile-app-builderSkill {
  constructor() {
    this.name = 'engineering-mobile-app-builder';
    this.agentPath = '/root/.openclaw/workspace/agency-agents/engineering/engineering-mobile-app-builder.md';
  }

  async execute(task, context = {}) {
    try {
      console.log('🤖 Executing Engineering Mobile App Builder agent...');
      ...
      console.log('✅ Engineering Mobile App Builder completed');
      return result;
    } catch (error) {
      console.error('❌ engineering-mobile-app-builder error:', error.message);
      throw error;
    }
  }
...
module.exports = { engineering-mobile-app-builderSkill };