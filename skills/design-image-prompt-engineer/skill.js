...
/**
 * Agency Agent Skill: Design Image Prompt Engineer
 * revenue: true
 */
...
class design-image-prompt-engineerSkill {
  constructor() {
    this.name = 'design-image-prompt-engineer';
    this.agentPath = '/root/.openclaw/workspace/agency-agents/design/design-image-prompt-engineer.md';
  }

  async execute(task, context = {}) {
    try {
      console.log('🤖 Executing Design Image Prompt Engineer agent...');
      ...
      console.log('✅ Design Image Prompt Engineer completed');
      return result;
    } catch (error) {
      console.error('❌ design-image-prompt-engineer error:', error.message);
      throw error;
    }
  }
...
module.exports = { design-image-prompt-engineerSkill };