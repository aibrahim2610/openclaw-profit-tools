...
/**
 * Agency Agent Skill: Engineering Devops Automator
 * revenue: true
 */
...
class engineering-devops-automatorSkill {
  constructor() {
    this.name = 'engineering-devops-automator';
    this.agentPath = '/root/.openclaw/workspace/agency-agents/engineering/engineering-devops-automator.md';
  }

  async execute(task, context = {}) {
    try {
      console.log('🤖 Executing Engineering Devops Automator agent...');
      ...
      console.log('✅ Engineering Devops Automator completed');
      return result;
    } catch (error) {
      console.error('❌ engineering-devops-automator error:', error.message);
      throw error;
    }
  }
...
module.exports = { engineering-devops-automatorSkill };