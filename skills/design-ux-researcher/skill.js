...
/**
 * Agency Agent Skill: Design Ux Researcher
 * revenue: true
 */
...
class design-ux-researcherSkill {
  constructor() {
    this.name = 'design-ux-researcher';
    this.agentPath = '/root/.openclaw/workspace/agency-agents/design/design-ux-researcher.md';
  }

  async execute(task, context = {}) {
    try {
      console.log('🤖 Executing Design Ux Researcher agent...');
      ...
      console.log('✅ Design Ux Researcher completed');
      return result;
    } catch (error) {
      console.error('❌ design-ux-researcher error:', error.message);
      throw error;
    }
  }
...
module.exports = { design-ux-researcherSkill };