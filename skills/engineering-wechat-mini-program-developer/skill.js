...
/**
 * Agency Agent Skill: Engineering Wechat Mini Program Developer
 * revenue: true
 */
...
class engineering-wechat-mini-program-developerSkill {
  constructor() {
    this.name = 'engineering-wechat-mini-program-developer';
    this.agentPath = '/root/.openclaw/workspace/agency-agents/engineering/engineering-wechat-mini-program-developer.md';
  }

  async execute(task, context = {}) {
    try {
      console.log('🤖 Executing Engineering Wechat Mini Program Developer agent...');
      ...
      console.log('✅ Engineering Wechat Mini Program Developer completed');
      return result;
    } catch (error) {
      console.error('❌ engineering-wechat-mini-program-developer error:', error.message);
      throw error;
    }
  }
...
module.exports = { engineering-wechat-mini-program-developerSkill };