...
/**
 * Agency Agent Skill: Engineering Backend Architect
 * revenue: true
 */
...
class engineering-backend-architectSkill {
  constructor() {
    this.name = 'engineering-backend-architect';
    this.agentPath = '/root/.openclaw/workspace/agency-agents/engineering/engineering-backend-architect.md';
  }

  async execute(task, context = {}) {
    try {
      console.log('🤖 Executing Engineering Backend Architect agent...');
      ...
      console.log('✅ Engineering Backend Architect completed');
      return result;
    } catch (error) {
      console.error('❌ engineering-backend-architect error:', error.message);
      throw error;
    }
  }
...
module.exports = { engineering-backend-architectSkill };