...
/**
 * Agency Agent Skill: Engineering Incident Response Commander
 * revenue: true
 */
...
class engineering-incident-response-commanderSkill {
  constructor() {
    this.name = 'engineering-incident-response-commander';
    this.agentPath = '/root/.openclaw/workspace/agency-agents/engineering/engineering-incident-response-commander.md';
  }

  async execute(task, context = {}) {
    try {
      console.log('🤖 Executing Engineering Incident Response Commander agent...');
      ...
      console.log('✅ Engineering Incident Response Commander completed');
      return result;
    } catch (error) {
      console.error('❌ engineering-incident-response-commander error:', error.message);
      throw error;
    }
  }
...
module.exports = { engineering-incident-response-commanderSkill };