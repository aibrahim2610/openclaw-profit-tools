...
/**
 * Agency Agent Skill: Engineering Senior Developer
 * revenue: true
 */
...
class engineering-senior-developerSkill {
  constructor() {
    this.name = 'engineering-senior-developer';
    this.agentPath = '/root/.openclaw/workspace/agency-agents/engineering/engineering-senior-developer.md';
  }

  async execute(task, context = {}) {
    try {
      console.log('🤖 Executing Engineering Senior Developer agent...');
      ...
      console.log('✅ Engineering Senior Developer completed');
      return result;
    } catch (error) {
      console.error('❌ engineering-senior-developer error:', error.message);
      throw error;
    }
  }
...
module.exports = { engineering-senior-developerSkill };