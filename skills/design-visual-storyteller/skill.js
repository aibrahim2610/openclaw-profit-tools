...
/**
 * Agency Agent Skill: Design Visual Storyteller
 * revenue: true
 */
...
class design-visual-storytellerSkill {
  constructor() {
    this.name = 'design-visual-storyteller';
    this.agentPath = '/root/.openclaw/workspace/agency-agents/design/design-visual-storyteller.md';
  }

  async execute(task, context = {}) {
    try {
      console.log('🤖 Executing Design Visual Storyteller agent...');
      ...
      console.log('✅ Design Visual Storyteller completed');
      return result;
    } catch (error) {
      console.error('❌ design-visual-storyteller error:', error.message);
      throw error;
    }
  }
...
module.exports = { design-visual-storytellerSkill };