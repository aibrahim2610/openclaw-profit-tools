...
/**
 * Agency Agent Skill: Engineering Rapid Prototyper
 * revenue: true
 */
...
class engineering-rapid-prototyperSkill {
  constructor() {
    this.name = 'engineering-rapid-prototyper';
    this.agentPath = '/root/.openclaw/workspace/agency-agents/engineering/engineering-rapid-prototyper.md';
  }

  async execute(task, context = {}) {
    try {
      console.log('🤖 Executing Engineering Rapid Prototyper agent...');
      ...
      console.log('✅ Engineering Rapid Prototyper completed');
      return result;
    } catch (error) {
      console.error('❌ engineering-rapid-prototyper error:', error.message);
      throw error;
    }
  }
...
module.exports = { engineering-rapid-prototyperSkill };