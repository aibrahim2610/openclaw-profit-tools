...
/**
 * Agency Agent Skill: Engineering Embedded Firmware Engineer
 * revenue: true
 */
...
class engineering-embedded-firmware-engineerSkill {
  constructor() {
    this.name = 'engineering-embedded-firmware-engineer';
    this.agentPath = '/root/.openclaw/workspace/agency-agents/engineering/engineering-embedded-firmware-engineer.md';
  }

  async execute(task, context = {}) {
    try {
      console.log('🤖 Executing Engineering Embedded Firmware Engineer agent...');
      ...
      console.log('✅ Engineering Embedded Firmware Engineer completed');
      return result;
    } catch (error) {
      console.error('❌ engineering-embedded-firmware-engineer error:', error.message);
      throw error;
    }
  }
...
module.exports = { engineering-embedded-firmware-engineerSkill };