...
/**
 * Agency Agent Skill: Design Ui Designer
 * revenue: true
 */
...
class design-ui-designerSkill {
  constructor() {
    this.name = 'design-ui-designer';
    this.agentPath = '/root/.openclaw/workspace/agency-agents/design/design-ui-designer.md';
  }

  async execute(task, context = {}) {
    try {
      console.log('🤖 Executing Design Ui Designer agent...');
      ...
      console.log('✅ Design Ui Designer completed');
      return result;
    } catch (error) {
      console.error('❌ design-ui-designer error:', error.message);
      throw error;
    }
  }
...
module.exports = { design-ui-designerSkill };