...
/**
 * Agency Agent Skill: Design Inclusive Visuals Specialist
 * revenue: true
 */
...
class design-inclusive-visuals-specialistSkill {
  constructor() {
    this.name = 'design-inclusive-visuals-specialist';
    this.agentPath = '/root/.openclaw/workspace/agency-agents/design/design-inclusive-visuals-specialist.md';
  }

  async execute(task, context = {}) {
    try {
      console.log('🤖 Executing Design Inclusive Visuals Specialist agent...');
      ...
      console.log('✅ Design Inclusive Visuals Specialist completed');
      return result;
    } catch (error) {
      console.error('❌ design-inclusive-visuals-specialist error:', error.message);
      throw error;
    }
  }
...
module.exports = { design-inclusive-visuals-specialistSkill };