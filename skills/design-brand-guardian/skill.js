...
/**
 * Agency Agent Skill: Design Brand Guardian
 * revenue: true
 */
...
class design-brand-guardianSkill {
  constructor() {
    this.name = 'design-brand-guardian';
    this.agentPath = '/root/.openclaw/workspace/agency-agents/design/design-brand-guardian.md';
  }

  async execute(task, context = {}) {
    try {
      console.log('🤖 Executing Design Brand Guardian agent...');
      ...
      console.log('✅ Design Brand Guardian completed');
      return result;
    } catch (error) {
      console.error('❌ design-brand-guardian error:', error.message);
      throw error;
    }
  }
...
module.exports = { design-brand-guardianSkill };